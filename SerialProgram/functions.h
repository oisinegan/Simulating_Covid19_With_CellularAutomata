...
#define generationNumber 500

// define how often to write world to file
#define numWriteToFile 1000

// Days for transform
#define EXPOSED_TO_INFECTED 3
#define INFECTED_TO_RECOVERED 14
#define RECOVERED_TO_SUSCEPTIBLE 90
#define DEAD_TO_SUSCEPTIBLE 30

// percentage chance of death per day while infected
#define DEATH_CHANCE 2
